...
const initialState = {
  ...
  questions: [
    ...
    {
      q1b: {
        questionText: "NO, I DO NOT want to automatically receive an early ballot. I understand CHECKING THIS BOX will remove my name from the list if it was previously included.",
...
const voterReducerAzEnglish = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.DECREMENT_INDEX_ENGLISH:
      let index = state.index--;
      return Object.assign({}, state, {
        index
      });
    case actionTypes.INCREMENT_INDEX_ENGLISH:
      let index = state.index++;
      return Object.assign({}, state, {
        index
      });
    case actionTypes.EDIT_RESPONSE:
      return state;
    case actionTypes.GET_QUESTIONS_AZ_ENGLISH:
      console.log(action);
      return state;
...
export default voterReducerAzEnglish;
